...
import com.example.skb_android.vacancy.impl.di.vacanciesModule
...
class App : Application() {
    ...
    private fun createNotificationChannel() {
        ...
        val channel = NotificationChannel(
            getString(com.example.skb_android.core.R.string.notifications_channel_id),
            getString(com.example.skb_android.core.R.string.notifications_channel_name),
